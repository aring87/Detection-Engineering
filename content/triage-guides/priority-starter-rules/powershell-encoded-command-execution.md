...
## Detection Objective
Detects PowerShell execution with -enc or EncodedCommand arguments and decodes the command for analyst review.

## What the Detection Is Looking For
This analytic is intended to highlight behavior that can indicate attacker activity related to execution. Review the triggering event in the broader context of the user, host, parent process, and surrounding activity.
...
- Validate account, device, and parent process context
- Correlate with file, registry, and network events

## Validation Checklist
- [ ] Run benign encoded PowerShell commands in a lab and confirm decoding
...
| project Timestamp, DeviceName, AccountName, FileName, ProcessCommandLine, Encoded, Decoded
```
